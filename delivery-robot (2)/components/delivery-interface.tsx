...
import { Package, Lock, Unlock, AlertTriangle, MapPin, Clock, ArrowRight, Pause } from "lucide-react"
...
export default function DeliveryInterface() {
    ...
    return (
      <div className="w-full max-w-4xl mx-auto">
        <ResponsiveContainer aspectRatio="16/9">
          <Card className="w-full h-full border-none shadow-xl overflow-hidden bg-gradient-to-br from-amber-950 to-slate-900">
              ...
              >
                <SwiperSlide>
                  <div className="flex flex-col items-center justify-center h-full p-8 text-center">
                    ...
                    >
                      <h1 className="text-4xl md:text-5xl font-bold text-amber-500 mb-4">Pharoah LORM</h1>
                      <p className="text-xl text-amber-200 mb-8">Lively Oxygen-Respecting Messenger</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <Button variant="futuristic" size="touch" onClick={startApp} className="text-white">
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      <ResponsiveContainer aspectRatio={isMobile ? "1/1" : "16/9"}>
        <Card className="w-full h-full border-none shadow-xl overflow-hidden bg-gradient-to-br from-amber-950 to-slate-900">
          <EgyptianPatternBorder>
            <div className="h-full flex flex-col">
              {/* Header with status info */}
              <div className="bg-amber-900/50 border-b border-amber-800/50 p-2 flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  <TimeClock />
                  <Badge
                    variant={deliveryStage === DELIVERY_STAGES.IDLE ? "outline" : "default"}
                    className="bg-amber-800/50 text-amber-200 border-amber-700"
                  >
              ...
              <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
                {/* Left panel - Map */}
                <div className={`${isMobile ? "w-full h-1/2" : "w-3/5 h-full"} p-2`}>
                ...
                <div
                  className={`${isMobile ? "w-full h-1/2" : "w-2/5 h-full"} p-2 flex flex-col space-y-2 overflow-auto`}
                >
                  {/* Status panel */}
                  <FuturisticContainer className="p-3">
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-amber-400 text-sm">Status</h3>
                      <div className="flex items-center space-x-2">
                        <Badge
                          variant={isLocked ? "destructive" : "outline"}
                          className={`${
                            isLocked ? "bg-red-900 text-red-200" : "bg-amber-900/50 text-amber-200 border-amber-700"
                          }`}
                        >
                  ...
                  <FuturisticContainer className="flex-1 p-3 overflow-auto">
                    {deliveryStage === DELIVERY_STAGES.IDLE && (
                      <div className="h-full flex flex-col">
                        <div className="flex-1 flex flex-col items-center justify-center text-center p-4">
                          ...
                          <h3 className="text-amber-400 text-lg mb-2">Ready for Delivery</h3>
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="flex justify-between items-center mb-1">
                            <h3 className="text-amber-400 text-sm">Delivery Progress</h3>
                            <div className="flex items-center">
                              <Clock className="h-4 w-4 text-amber-400 mr-1" />
                              <span className="text-amber-200 text-xs">{eta} min remaining</span>
                            </div>
                          </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 pt-2">
                          <div className="space-y-1">
                            ...
                            <span className="text-amber-100 text-sm">{startLocation.name}</span>
                          </div>
                          ...
                          <div className="space-y-1">
                            ...
                            <span className="text-amber-100 text-sm">{destination.name}</span>
                          </div>
                        </div>

                        <div className="space-y-1 pt-2">
                          <div className="flex items-center">
                            <Package className="h-4 w-4 text-amber-400 mr-1" />
                            <span className="text-amber-200 text-xs">Route:</span>
                          </div>
                        ...
                        <div className="flex space-x-2 pt-2">
                          <Button
                            ...
                            className="flex-1 border-amber-700 text-amber-200"
                          >
                    ...
                    {deliveryStage === DELIVERY_STAGES.ARRIVED && (
                      <div className="space-y-4">
                        <div className="text-center">
                          ...
                          <h3 className="text-amber-400 text-lg mb-1">Destination Reached</h3>
                          <p className="text-amber-200 text-sm mb-4">Your delivery has arrived at {destination.name}</p>
                        </div>
                        ...
                        <div className="space-y-3">
                          <div className="text-center">
                            ...
                            {isAuthenticated && user?.academicId && (
                              <p className="text-amber-400/70 text-xs mb-4">Use your Academic ID: {user.academicId}</p>
                            )}
                          </div>
                          ...
                          <Input
                            ...
                            className="bg-amber-900/50 border-amber-700 text-amber-100 text-center"
                            maxLength={7}
                          />
                    ...
                    {deliveryStage === DELIVERY_STAGES.PIN_VERIFICATION && (
                      <div className="space-y-4">
                        <div className="text-center">
                          <h3 className="text-amber-400 text-lg mb-1">Verifying PIN</h3>
                          <p className="text-amber-200 text-sm mb-4">Please wait...</p>
                        </div>
                      </div>
                    )}
                    ...
                    {deliveryStage === DELIVERY_STAGES.DOOR_OPEN && (
                      <div className="space-y-4">
                        <div className="text-center">
                          ...
                          <h3 className="text-amber-400 text-lg mb-1">Compartment Unlocked</h3>
                          <p className="text-amber-200 text-sm mb-4">Please take your package</p>
                        </div>
                        ...
                        <Button
                          ...
                          className="w-full border-amber-700 text-amber-200"
                        >
                          Close Compartment
                        </Button>
                      </div>
                    ...
                    {deliveryStage === DELIVERY_STAGES.DOOR_CLOSED && (
                      <div className="space-y-4">
                        <div className="text-center">
                          <Badge className="bg-amber-600 text-white mb-2">Door Closed</Badge>
                          <h3 className="text-amber-400 text-lg mb-1">Compartment Closed</h3>
                    ...
                    {deliveryStage === DELIVERY_STAGES.COMPLETED && (
                      <div className="space-y-4">
                        <div className="text-center">
                          ...
                          <h3 className="text-amber-400 text-lg mb-1">Delivery Completed</h3>
                          <p className="text-amber-200 text-sm mb-4">Thank you for using Pharoah LORM</p>
                        </div>

                        <div className="bg-amber-900/30 rounded-md p-3 border border-amber-800/50 mb-3">
                          <h4 className="text-amber-300 text-sm mb-2">Delivery Summary</h4>
                          <div className="grid grid-cols-2 gap-2 text-xs">
                            <div className="text-amber-200">From:</div>
                            <div className="text-amber-100">{startLocation.name}</div>
                            <div className="text-amber-200">To:</div>
                            <div className="text-amber-100">{destination.name}</div>
                            <div className="text-amber-200">Route:</div>
                            <div className="text-amber-100">{routes[selectedRouteIndex]?.name}</div>
                            <div className="text-amber-200">Distance:</div>
                            <div className="text-amber-100">{routes[selectedRouteIndex]?.distance} km</div>
                            <div className="text-amber-200">Time:</div>
                            <div className="text-amber-100">{routes[selectedRouteIndex]?.eta} min</div>
                          </div>
                        </div>

                        <Button variant="futuristic" size="touch" onClick={resetDemo} className="w-full text-white">
                          <ArrowRight className="mr-2 h-4 w-4" />
                          Start New Delivery
                        </Button>
                      </div>
                    ...
                    {deliveryStage === DELIVERY_STAGES.LOCKED && (
                      <div className="space-y-4">
                        <div className="text-center">
                          ...
                          <p className="text-amber-200 text-sm mb-4">
                            The system has been locked due to multiple failed PIN attempts. Please contact support.
                          </p>
                        </div>
                        ...
                        <Button
                          ...
                          size="touch"
                          onClick={resetDemo}
                          className="w-full border-amber-700 text-amber-200 mt-4"
                        >
                          Reset Demo
                        </Button>
                      </div>
